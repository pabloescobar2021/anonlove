...
function useDeleteMessage(p) {
    ...
    const hideMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDeleteMessage.useCallback[hideMessage]": async (ids)=>{
            if (!ids.length) return;
            const bubbles = ids.map({
                "useDeleteMessage.useCallback[hideMessage].bubbles": (id)=>bubbleRef?.current[id]
            }["useDeleteMessage.useCallback[hideMessage].bubbles"]).filter({
                "useDeleteMessage.useCallback[hideMessage].bubbles": (el)=>Boolean(el)
            }["useDeleteMessage.useCallback[hideMessage].bubbles"]);
            const wrappers = ids.map({
                "useDeleteMessage.useCallback[hideMessage].wrappers": (id)=>wrapperRef?.current[id]
            }["useDeleteMessage.useCallback[hideMessage].wrappers"]).filter({
                "useDeleteMessage.useCallback[hideMessage].wrappers": (el)=>Boolean(el)
            }["useDeleteMessage.useCallback[hideMessage].wrappers"]);
            wrappers.forEach({
                "useDeleteMessage.useCallback[hideMessage]": (el)=>{
                    el.style.height = `${el.offsetHeight}px`;
                }
            }["useDeleteMessage.useCallback[hideMessage]"]);
            shatterMessages(bubbles, {
                "useDeleteMessage.useCallback[hideMessage]": async ()=>{
                    try {
                        requestAnimationFrame({
                            "useDeleteMessage.useCallback[hideMessage]": ()=>{
                                setDeletingMsg([
                        ...
                        await Promise.all(wrappers.map({
                            "useDeleteMessage.useCallback[hideMessage]": (el)=>new Promise({
                                    "useDeleteMessage.useCallback[hideMessage]": (resolve)=>{
                                        const onEnd = {
                                            "useDeleteMessage.useCallback[hideMessage].onEnd": (e)=>{
                                                if (e.propertyName !== 'height') return;
                                                el.removeEventListener('transitionend', onEnd);
                                                resolve();
                                            }
                                        }["useDeleteMessage.useCallback[hideMessage].onEnd"];
                        ...
                        setMessages({
                            "useDeleteMessage.useCallback[hideMessage]": (prev)=>prev.filter({
                                    "useDeleteMessage.useCallback[hideMessage]": (msg)=>!ids.includes(msg.id)
                                }["useDeleteMessage.useCallback[hideMessage]"])
                        }["useDeleteMessage.useCallback[hideMessage]"]);
                        setDeletingMsg([]);
...
_s(useDeleteMessage, "viK7jhTTlEWPO8APOUR8i20fdqA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/app/things/hooks/dialog_messages/useGetMessages.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useGetMessages(conversationId) {
    ...
    const [initialTopMostItemIndex, setInitialTopMostItemIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const [firstItemIndex, setFirstItemIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1000000);
    const [visibleRange, setVisibleRange] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        startIndex: 0,
        endIndex: 0
    });
    const virtuosoRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const currentScrollIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])({
        startIndex: 0,
        endIndex: 0
    });
    const hasMoreRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    ...
    const loadMessages = async (cursor)=>{
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("get_conversation_messages", {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGetMessages.useEffect": ()=>{
            ...
            if (channelRef.current) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].removeChannel(channelRef.current);
                channelRef.current = null;
            }
            // console.log("📡 Setting up realtime for conversation:", conversationId)
            channelRef.current = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`messages-${conversationId}`).on("postgres_changes", {
                event: "INSERT",
                schema: "public",
                table: "messages",
                filter: `conversation_id=eq.${conversationId}`
            }, {
                "useGetMessages.useEffect": (payload)=>{
                    console.log("📩 New message received:", payload);
                    loadMessages(null);
                }
            }["useGetMessages.useEffect"]).on("system", {}, {
                "useGetMessages.useEffect": (payload)=>{
                // console.log("⚙️ Realtime system event:", payload)
                }
            }["useGetMessages.useEffect"]).subscribe({
                "useGetMessages.useEffect": (status, err)=>{
    ...
    const startReached = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGetMessages.useCallback[startReached]": ()=>{
...
_s(useGetMessages, "Qn65UL8OL5emYxJkQqWHSUxfedw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/app/anonMain/chat/ChatMessage.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const ChatMessage = /*#__PURE__*/ _s(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].memo(_c = _s(function ChatMessage(p) {
    _s();
    const { message, userId, wrapperRef, bubbleRef, isDeletingMsg, isSelectTouched, setSelectTouched, isChoose, setChoosenMsg, isChoosenMsg, isMobile, setAction, timer, cancelTouch, styleButton } = p;
    ...
    const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$utils$2f$parseDate$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatBackendDate"])(message.created_at);
    const setWrapper = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatMessage.ChatMessage.useCallback[setWrapper]": (el)=>{
            wrapperRef.current[message.id] = el;
        }
    }["ChatMessage.ChatMessage.useCallback[setWrapper]"], [
        message.id
    ]);
    const setBubble = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatMessage.ChatMessage.useCallback[setBubble]": (el)=>{
            bubbleRef.current[message.id] = el;
        }
    }["ChatMessage.ChatMessage.useCallback[setBubble]"], [
        message.id
    ]);
    const handleClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatMessage.ChatMessage.useCallback[handleClick]": ()=>{
            if (isChoose) {
                setChoosenMsg({
                    "ChatMessage.ChatMessage.useCallback[handleClick]": (prev)=>prev.includes(message.id) ? prev.filter({
                            "ChatMessage.ChatMessage.useCallback[handleClick]": (id)=>id !== message.id
                        }["ChatMessage.ChatMessage.useCallback[handleClick]"]) : [
                            ...prev,
                            message.id
                        ]
    ...
    const handleContextMenu = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatMessage.ChatMessage.useCallback[handleContextMenu]": (e)=>{
            if (isMobile) return;
            e.preventDefault();
    ...
    }["ChatMessage.ChatMessage.useCallback[handleContextMenu]"], [
        isMobile,
        message,
        isMine,
        setAction,
    ...
    const handlePointerDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ChatMessage.ChatMessage.useCallback[handlePointerDown]": (e)=>{
            if (!isMobile || isChoose) return;
            if (e.pointerType !== "touch") return;
            const target = e.currentTarget;
            setSelectTouched(message.id);
            timer.current = window.setTimeout({
                "ChatMessage.ChatMessage.useCallback[handlePointerDown]": ()=>{
            ...
            }["ChatMessage.ChatMessage.useCallback[handlePointerDown]"], 400);
        }
    }["ChatMessage.ChatMessage.useCallback[handlePointerDown]"], [
        isMobile,
        isChoose,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            fileName: "[project]/app/anonMain/chat/ChatMessage.tsx",
                            lineNumber: 136,
                            columnNumber: 21
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
}, "Ic+BjTA2YU+6HX9lJSMkgoPf5b0=", false, function() {
    return [
...
_c1 = ChatMessage;
var _c, _c1;
__turbopack_context__.k.register(_c, "ChatMessage$React.memo");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$hooks$2f$dialog_messages$2f$useGetMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/things/hooks/dialog_messages/useGetMessages.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonMain$2f$chat$2f$ChatMessage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/anonMain/chat/ChatMessage.tsx [app-client] (ecmascript)");
...
function ManagerChat(props) {
    ...
    const choosenMsgSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ManagerChat.useMemo[choosenMsgSet]": ()=>{
            return new Set(choosenMsg);
        }
    }["ManagerChat.useMemo[choosenMsgSet]"], [
        choosenMsg
    ]);
    ...
    const { messages, setMessages, loading, loadingMore, hasMore, initialTopMostItemIndex, virtuosoRef, startReached, rangeChanged, firstItemIndex, currentScrollIndex } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$hooks$2f$dialog_messages$2f$useGetMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetMessages"])(activeDialogId);
    ...
    const dialogPanelRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null); // dialogResizeHandler (только для desktop)
    const bottomRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null) // для скролла к последнему сообщению
    ;
    const closeMenu = ()=>{
        setAction(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ManagerChat.useEffect": ()=>{
            ...
            const found = dialog.find({
                "ManagerChat.useEffect": (d)=>d.conversation_id === activeDialogId
    ...
    const { hideMessage, deletingMsg } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonMain$2f$useDeleteMessage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDeleteMessage"])({
        setAction,
        setMessages,
        bubbleRef: bubbleRef,
    ...
    const deletingSet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ManagerChat.useMemo[deletingSet]": ()=>new Set(deletingMsg)
    }["ManagerChat.useMemo[deletingSet]"], [
        deletingMsg
    ]);
    ...
    // стиль сообщений
    const getMessageStyle = (index, startIndex, endIndex)=>{
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: dialog.map((dialog)=>{
                            ...
                            const timeSend = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$utils$2f$parseDate$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatBackendDate"])(dialog.updated_at);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: `flex-1 bg-[#0e0406]
                    ${isMobile ? `absolute inset-0 bg-[#12080b] transition-transform duration-300 ease-in-out will-change-transform 
                        ${openChat ? "translate-x-0" : "translate-x-full"}` : "flex-1 flex flex-col relative"}
                `,
                ...isMobile ? chatSwipe : {},
                children: [
                    activeChatUserId && !isChoose && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute left-0 top-0 w-full flexC py-2 z-30",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    loading && !messages.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$virtuoso$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Virtuoso"], {
                        ...
                        itemContent: (index, message)=>{
                            ...
                            const style = getMessageStyle(index, startIndex, endIndex);
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonMain$2f$chat$2f$ChatMessage$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ChatMessage"], {
                                message: message,
                                userId: userId,
                                wrapperRef: wrapperRef,
                                bubbleRef: bubbleRef,
                        ...
                        components: {
                            Item: ({ children, ...props })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...props,
                                    style: {
                                        padding: '5px'
                                    },
...
_s(ManagerChat, "ERWP92+TrOYPeT1H5pG44IcvIYY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$hooks$2f$dialog_messages$2f$useGetMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetMessages"],
...
_s(ProfilePanel, "XNEyw+5J+LMZGjIJ14R+W0B/8rY=", false, function() {
    return [
...
"[project]/app/things/hooks/dialog_messages/useGetDialogs.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useGetDialogs(userId) {
    ...
    const getDialog = async ()=>{
        if (!userId) return;
        setLoading(true);
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc("get_user_conversations", {
            p_user: userId
        });
        if (error) {
            console.error(error);
...
_s(useGetDialogs, "EnTxt/41Xh49u2uOla2QugBT4QA=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$hooks$2f$dialog_messages$2f$useGetDialogs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/things/hooks/dialog_messages/useGetDialogs.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/supabase/alSupabase.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function MainPage() {
    ...
    const { dialogs: dialog, loading, refresh: refreshDialog } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$hooks$2f$dialog_messages$2f$useGetDialogs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetDialogs"])(user?.id || null);
    ...
    const globalChannelRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MainPage.useEffect": ()=>{
            ...
            if (globalChannelRef.current) {
                __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].removeChannel(globalChannelRef.current);
                globalChannelRef.current = null;
            }
            globalChannelRef.current = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`user-${user.id}-messages`).on("postgres_changes", {
                event: "INSERT",
                schema: "public",
                table: "messages",
                filter: `to_user=eq.${user.id}`
            }, {
                "MainPage.useEffect": (payload)=>{
                    const msg = payload.new;
                    console.log("New message received via realtime:", msg);
                    refreshDialog();
                }
            }["MainPage.useEffect"]).subscribe({
                "MainPage.useEffect": (status, err)=>{
...
_s(MainPage, "s0hTqxdgTPhgXE4dBehGe8hwWFI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$hooks$2f$dialog_messages$2f$useGetDialogs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetDialogs"],
...
//# sourceMappingURL=_b2c2ef45._.js.map