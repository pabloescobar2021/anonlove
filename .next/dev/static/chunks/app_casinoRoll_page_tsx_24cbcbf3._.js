...
(()=>{
    const e = new Error("Cannot find module './utils/visual'");
...
function Roll() {
    ...
    const sectors = activeLots.map((lot, index)=>{
        ...
        currentAngle = end;
        const coords = getTextCoords(cx, cy, radius, start, end);
        return {
            ...lot,
            start,
            end,
...
//# sourceMappingURL=app_casinoRoll_page_tsx_24cbcbf3._.js.map