...
"use client";
;
function MessagePanel({ contextMenu, onClose }) {
    _s();
...
_s(MessagePanel, "QMBuJFIdzLIeqBcFwhMf246mjOM=");
_c = MessagePanel;
var _c;
...
function Page() {
    ...
    const { inbox, sent, sendMessage: send, loading: messageLoading, refresh } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonlove$2f$things$2f$hooks$2f$useMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMessages"])(user?.id || null);
...
_s(Page, "cwQh7TDUNbCp31vVWioK5j1wv/o=", false, function() {
    return [
...
//# sourceMappingURL=_8f50b398._.js.map