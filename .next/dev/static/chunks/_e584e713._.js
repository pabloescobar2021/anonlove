...
_s(userItemInteractions, "1mQPtjuJJgY9ff2U3mxghiim2/U=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function CreateCardPage({ initialData }) {
    ...
    const { message, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonlove$2f$things$2f$hooks$2f$useMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentMessage"])(isRecieve ? user?.id || null : null, isRecieve ? messageId : null);
    ...
    const { startDrag, startResize, deleteItem } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonlove$2f$createcard$2f$useItemInteractions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["userItemInteractions"])(items, setItems, fieldRef, viewport);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateCardPage.useEffect": ()=>{
            if (!isRecieve) return;
            if (!message) return;
            setItems((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonlove$2f$things$2f$types$2f$type$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["itemDtoListToItems"])(message.body));
        }
    }["CreateCardPage.useEffect"], [
        isRecieve,
        message
...
_s(CreateCardPage, "5HGxslmD/rkgLOQKhVDaneSmJRQ=", false, function() {
    return [
...
//# sourceMappingURL=_e584e713._.js.map