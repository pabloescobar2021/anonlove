...
"[project]/app/casinoRoll/utils/sectorMath.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/casinoRoll/notification/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function Notify({ onAddLot, onNewLot, notifyLots }) {
    _s();
    const [lastSync, setLastSync] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(Date.now());
    const [hoverId, setHoveredId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Notify.useEffect": ()=>{
            const fetchLots = {
                "Notify.useEffect.fetchLots": async ()=>{
                    try {
                        const res = await fetch(`/api/lots?since=${lastSync}`);
                        const serverLots = await res.json();
                        if (serverLots.length) onNewLot(serverLots);
                        setLastSync(Date.now());
                    } catch (err) {
                        console.error(err);
                    }
                }
            }["Notify.useEffect.fetchLots"];
            const interval = setInterval(fetchLots, 5000);
            return ({
                "Notify.useEffect": ()=>clearInterval(interval)
            })["Notify.useEffect"];
        }
    }["Notify.useEffect"], [
        lastSync
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex flex-col w-full border-l",
        children: notifyLots.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                onMouseEnter: ()=>setHoveredId(item.id),
                onMouseLeave: ()=>setHoveredId(null),
                className: `flex gap-1 w-full border p-2 cursor-grab`,
                draggable: true,
                onDragStart: (e)=>{
                    e.dataTransfer.setData("application/lot", JSON.stringify(item));
                },
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        fileName: "[project]/app/casinoRoll/notification/page.tsx",
                        lineNumber: 60,
                        columnNumber: 21
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Notify, "+vCz0g+IsSpJQlIOdm/crwsj3/E=");
_c = Notify;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$sectorMath$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/casinoRoll/utils/sectorMath.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$notification$2f$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/casinoRoll/notification/page.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Roll() {
    ...
    const [notifyLots, setNotifyLots] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [hoveredLotId, setHoveredLotId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null); //визуальный эффект при наведении на лот
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Roll.useEffect": ()=>{
            try {
    ...
    const activeLots = lots.filter((lot)=>lot.enabled !== false).map((l)=>{
        return {
            ...l,
            weight: 1 / l.weight
        };
    ...
    const filteredLots = lots.sort((lot1, lot2)=>lot2.weight - lot1.weight); //фильтр для вывода лотов
    ...
    const sectors = activeLots.map((lot, index)=>{
        ...
        currentAngle = end;
        const coords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$sectorMath$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTextCoords"])(cx, cy, radius, start, end);
        return {
            ...lot,
            start,
            end,
            path: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$sectorMath$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["describeArc"])(cx, cy, radius, start, end),
            textX: coords.x,
            textY: coords.y,
            textAngle: coords.rotation,
            color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$sectorMath$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateColor"])(index)
        };
    });
    const spin = ()=>{
    ...
    const addLot = ()=>{
        ...
        setLots((prev)=>[
                ...prev,
                {
                    ...
                    label: name,
                    weight,
                    color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$sectorMath$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateColor"])(prev.length),
                    enabled: true,
                    createdAt: Date.now()
                }
            ]);
    ...
    // Добавляем лот из notify
    const addLotsFromNotify = (newLots)=>{
        setNotifyLots((prev)=>{
            const merged = [
                ...prev
            ];
            newLots.forEach((lot)=>{
                if (!merged.find((l)=>l.id === lot.id)) merged.push(lot);
            });
            return merged;
        });
    };
    const addLotToMain = (lot)=>{
        setLots((prev)=>[
                ...prev,
                lot
            ]);
        setNotifyLots((prev)=>prev.filter((l)=>l.id !== lot.id));
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            filteredLots.map((lot)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            `,
                                    ...
                                    onDrop: (e)=>{
                                        const raw = e.dataTransfer.getData("application/lot");
                                        if (!raw) return;
                                        const draggedLot = JSON.parse(raw);
                                        setLots((prev)=>prev.map((l)=>l.id === lot.id ? {
                                                    ...l,
                                                    weight: l.weight + draggedLot.weight
                                                } : l));
                                        setNotifyLots((prev)=>prev.filter((l)=>l.id !== draggedLot.id));
                                    },
                                    children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$notification$2f$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                notifyLots: notifyLots,
                onAddLot: addLotToMain,
                onNewLot: addLotsFromNotify
            }, void 0, false, {
                fileName: "[project]/app/casinoRoll/page.tsx",
                lineNumber: 408,
                columnNumber: 13
...
_s(Roll, "gV7kJbvD4f4bcbPofdo4Hng84j0=");
_c = Roll;
var _c;
...
//# sourceMappingURL=app_casinoRoll_a5a183ca._.js.map