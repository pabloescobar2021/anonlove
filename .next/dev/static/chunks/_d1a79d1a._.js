...
;
;
function useMessageRead(userId) {
    _s();
    const [isRead, setIsRead] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useMessageRead.useEffect": ()=>{
            if (!userId) return;
            const loadStatus = {
                "useMessageRead.useEffect.loadStatus": async ()=>{
                    try {
                        const status = await getReadStatus(messageId);
                        setIsRead(status.is_checked);
                    } catch (err) {
                        console.error("error load read status", err);
                    }
                }
            }["useMessageRead.useEffect.loadStatus"];
            loadStatus();
            if (isReceiver && userId) {
                const markRead = {
                    "useMessageRead.useEffect.markRead": async ()=>{
                        try {
                ...
                }["useMessageRead.useEffect.markRead"];
                markRead();
            }
        }
    }["useMessageRead.useEffect"], [
    ...
    const markAsRead = async (messageId1, userId)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("messages").update({
            is_checked: true
        }).eq("id", messageId1).eq("to_user", userId);
        if (error) {
            console.error("Error marking message as read:", error);
            throw error;
        }
    };
    const getReadStatus = async (messageId1)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("messages").select('is_checked').eq('id', messageId1).single();
        if (error) throw error;
        return data;
    };
}
_s(useMessageRead, "NFDTLEWYF70/Sm+5bqBVKOcdxT0=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function Page() {
    ...
    const { isRead } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonlove$2f$things$2f$hooks$2f$useCheckMsg$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMessageRead"])();
...
_s(Page, "aFZ320flUwXOOrCHA8mGNVZJDhU=", false, function() {
    return [
...
//# sourceMappingURL=_d1a79d1a._.js.map