...
function useShatterMessage(options) {
    ...
    const FADE = options?.fade || 0.025;
    const shatterMessage = async (messageEl, onRemove)=>{
        if (!messageEl || !canvasRef.current) return;
        const canvas = canvasRef.current;
        const ctx = canvas.getContext("2d", {
            willReadFrequently: true
        });
        const rect = messageEl.getBoundingClientRect();
        const rendererCanvas = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html$2d$to$2d$image$2f$es$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toCanvas"](messageEl, {
            width: rect.width,
            height: rect.height,
            style: {
                transform: 'none'
        ...
        const imageData = rendererCanvas.getContext("2d").getImageData(0, 0, rendererCanvas.width, rendererCanvas.height);
        const data = imageData.data;
        const particles = [];
        for(let y = 0; y < rendererCanvas.height; y += PIXEL_SIZE){
            for(let x = 0; x < rendererCanvas.width; x += PIXEL_SIZE){
                const i = (y * rendererCanvas.width + x) * 4;
                const a = data[i + 3];
                if (a > 50) {
                    particles.push({
                        x: rect.left + x,
...
_s(useShatterMessage, "hw7YJ5TVw+lAu0tRkzoDS8rL7/E=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function ManagerChat(props) {
    ...
    const { canvasRef, shatterMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonMain$2f$useShatterMessage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useShatterMessage"])({});
        ...
        children: [
            ...
            action && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$contextMenu$2f$messagePanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MessageActionRoot"], {
                ...
                onDelete: (id)=>{
                    const el = wrapperRef.current[id];
                    if (!el) return;
                    shatterMessage(el, ()=>handleRemoveMsg(id));
                },
                isChose: setIsChoose,
...
_s(ManagerChat, "mutlgLRHNXKvEHTkJhRhBTTcK08=", false, function() {
    return [
...
//# sourceMappingURL=_ca19b2b7._.js.map