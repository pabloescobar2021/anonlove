...
function DesktopChat(props) {
    ...
    //
    const { handleDeleteMessage, handleDeleteManyMsg } = useDeleteMessage({
        setChoosenMsg,
        setAction,
        setIsChoose,
        choosenMsg,
...
_s(DesktopChat, "jlFkKEnVzcTRgrb+s5FQBaJ2HWg=", true, function() {
    return [
...
//# sourceMappingURL=_ef39fb82._.js.map