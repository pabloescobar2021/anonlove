...
function useMessages(userId) {
    ...
    const send = async (to, body, isAnon)=>{
        ...
        if (error) throw error;
        const { error: errorMsg } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("messages_safe").insert({
            from_user: userId,
            to_user: receiverId,
            body
        });
...
_s(CreateCardPage, "2aQXhJPcAL/WPQr6ChY/NvVt8oU=", false, function() {
    return [
...
//# sourceMappingURL=_b244d56c._.js.map