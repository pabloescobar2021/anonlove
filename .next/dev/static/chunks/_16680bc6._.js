        ...
        "useGetMessages.useEffect": ()=>{
            ...
            channelRef.current = __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel(`messages-${conversationId}`).on("postgres_changes", {
                ...
                "useGetMessages.useEffect": (payload)=>{
                    ...
                    if (isAtBottom) {
                        requestAnimationFrame({
                            "useGetMessages.useEffect": ()=>container.scrollTop = container.scrollHeight
                        }["useGetMessages.useEffect"]);
                    }
                }
...
function ManagerChat(props) {
    ...
    const { messages, setMessages, loading, loadingMore, hasMore, refreshMessages, containerRef, handleScroll } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$things$2f$hooks$2f$dialog_messages$2f$useGetMessages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGetMessages"])(activeDialogId);
...
_s(ManagerChat, "NHItNUYOpjyS4Kob2H4FqU5yzVQ=", false, function() {
    return [
...
//# sourceMappingURL=_16680bc6._.js.map