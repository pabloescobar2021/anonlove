...
function Products({ initialProducts, pageSize }) {
    ...
    const pageRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(1); // текущая страница, первая уже загружена
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Products.useEffect": ()=>{
            const handleScroll = {
                "Products.useEffect.handleScroll": ()=>{
            ...
            return ({
                "Products.useEffect": ()=>window.removeEventListener("scroll", handleScroll)
            })["Products.useEffect"];
        }
    }["Products.useEffect"], [
        loading,
    ...
    const fetchNextPage = async ()=>{
        ...
        const { data } = await supabase.from("products").select("*").order("id").range(from, to);
...
_s(Products, "MVDcXUr6lvYmUCkeVKRtEZkzvHU=");
_c = Products;
var _c;
...
//# sourceMappingURL=app_Products_tsx_605c7711._.js.map