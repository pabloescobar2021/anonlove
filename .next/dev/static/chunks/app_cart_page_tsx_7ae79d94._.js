...
function CartPage() {
    _s();
    const { cart, updateQuantity, removeFromCart, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$cart$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartContext"])();
    if (cart.length === 0) {
...
_s(CartPage, "JUXgQ6WqVUq6wPclZQrAt3mB1lo=", false, function() {
    return [
