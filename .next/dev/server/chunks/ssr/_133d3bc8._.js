...
"[project]/app/Products.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Products({ initialProducts, pageSize }) {
    ...
    const fetchNextPage = async ()=>{
        ...
        setLoading(true);
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("products").select("*").gt("id", lastIdRef.current).order("id", {
            ascending: true
        }).limit(pageSize);
...
//# sourceMappingURL=_133d3bc8._.js.map