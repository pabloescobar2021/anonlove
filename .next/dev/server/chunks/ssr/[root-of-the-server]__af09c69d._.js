...
const userItemInteractions = (items, setItems, fieldRef, setViewport, viewport)=>{
    ...
    const getBounds = (scale, viewportW, viewportH, contentW, contentH)=>{
        const maxX = Math.max(0, (contentW * scale - viewportW) / 2);
        const maxY = Math.max(0, (contentH * scale - viewportH) / 2);
        return {
            maxX,
            maxY
        };
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: `absolute right-0 bottom-0 
                    ...
                    w-7 h-1/2 rounded-l-2xl bg-black/50 backdrop-blur-md hover:bg-white/20 transition-cursor
                    z-20
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af09c69d._.js.map