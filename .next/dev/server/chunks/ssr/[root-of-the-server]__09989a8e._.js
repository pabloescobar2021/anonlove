...
function useMessageRead(userId) {
    const [isRead, setIsRead] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!userId) return;
    ...
    const getReadStatus = async (messageId1)=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$alSupabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("messages").select('is_checked').eq('id', messageId1).single();
        if (error) throw error;
        return data;
    };
}
...
function Page() {
    ...
    const { isRead } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonlove$2f$things$2f$hooks$2f$useCheckMsg$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMessageRead"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__09989a8e._.js.map