...
"[project]/utils/supabase/supabaseAdmin.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/telegram/sendTelegramNotification.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$supabaseAdmin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/supabase/supabaseAdmin.ts [app-ssr] (ecmascript)");
;
async function sendTelegramNotification(userId, text) {
    const { data: user, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2f$supabaseAdmin$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("users").select("telegram_id").eq("id_user", userId).single();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$telegram$2f$sendTelegramNotification$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/telegram/sendTelegramNotification.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function useMessages(userId) {
    ...
    const send = async (to, body, isAnon)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$telegram$2f$sendTelegramNotification$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendTelegramNotification"])(receiverId, `Новое сообщение от ${userId}`);
        } catch (e) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__368e965b._.js.map