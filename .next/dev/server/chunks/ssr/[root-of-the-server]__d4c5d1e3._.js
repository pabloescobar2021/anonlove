...
function useShatterMessage(options) {
    ...
    const shatterMessage = async (messageEl, onRemove)=>{
        ...
        const rendererCanvas = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html$2d$to$2d$image$2f$es$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCanvas"](messageEl, {
            width: rect.width,
            height: rect.height,
            style: {
                transform: 'none'
...
function ManagerChat(props) {
    ...
    const { canvasRef, shatterMessage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$anonMain$2f$useShatterMessage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useShatterMessage"])({});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d4c5d1e3._.js.map