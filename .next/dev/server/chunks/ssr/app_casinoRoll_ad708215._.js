module.exports = [
"[project]/app/casinoRoll/utils/visual.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$visual$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/casinoRoll/utils/visual.tsx [app-ssr] (ecmascript)");
"use client";
;
;
;
function Roll() {
    ...
    const sectors = activeLots.map((lot, index)=>{
        ...
        currentAngle = end;
        const coords = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$visual$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTextCoords"])(cx, cy, radius, start, end);
        return {
            ...lot,
            start,
            end,
            path: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$visual$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["describeArc"])(cx, cy, radius, start, end),
            textX: coords.x,
            textY: coords.y,
            textAngle: coords.rotation,
            color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$visual$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateColor"])(index)
        };
    });
    const spin = ()=>{
    ...
    const addLot = ()=>{
        ...
        setLots((prev)=>[
                ...prev,
                {
                    ...
                    label: name,
                    weight,
                    color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$casinoRoll$2f$utils$2f$visual$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateColor"])(prev.length),
                    enabled: true
                }
            ]);
        setLotName('');
...
//# sourceMappingURL=app_casinoRoll_ad708215._.js.map